...
(** [classify pts n iter] takes in an array of points containing the data, 
number of clusters desired n, max number of iterations iter, and returns a
pair of points containing the centroids as the first element and classified
